...
//           style={{
//             height: hoveredIndex === i ? "400px" : "80px",
//           }}
  ...
  return (
    ...
    >
      ...
      {services.map((service, i) => (
        <div
          key={i}
          className={`relative z-10 block w-full overflow-hidden transition-all duration-600 border-b border-gray-600`}
          style={{
            height: hoveredIndex === i ? "400px" : "80px",
          }}
          onMouseEnter={() => setHoveredIndex(i)}
