    ...
    <main>
      ...
      <section className="max-w-7xl min-h-screen mx-auto flex md:flex-row flex-col items-center justify-center gap-8 py-10">
        <div className="flex flex-col items-center gap-2 border border-gray-700 py-4 px-8 shadow-sm shadow-black">
          <h3 className="text-transparent bg-gradient-to-t from-gray-700 to-white/20 bg-clip-text text-3xl/14 font-bold h-max">+300 Agents</h3>
        ...
        <div className="flex flex-col items-center gap-2 border border-gray-700 py-4 px-8 shadow-sm shadow-black">
          <h3 className="text-transparent bg-gradient-to-t from-gray-700 to-white/20 bg-clip-text text-3xl/14 font-bold h-max">100% Success Rate</h3>
          <p className="text-center text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates ea minus quia non. Est officiis non distinctio ipsa. Tempore at cumque asperiores itaque, quas ipsam.</p>
        </div>

        <div className="flex flex-col items-center gap-2 border border-gray-700 py-4 px-8 shadow-sm shadow-black">
          <h3 className="text-transparent bg-gradient-to-t from-gray-700 to-white/20 bg-clip-text text-3xl/14 font-bold h-max">+20 Elite Advisor</h3>
          <p className="text-center text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates ea minus quia non. Est officiis non distinctio ipsa. Tempore at cumque asperiores itaque, quas ipsam.</p>
        </div>
      </section>
